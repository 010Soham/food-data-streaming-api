...
def fetch_data(year: int = None, country: str = None, market: str = None):
    try:
        ...
        df = pd.read_csv("https://ap-south-1-admin-user-bucket1.s3.ap-south-1.amazonaws.com/total_data.csv")
        ...
        #If we insert None kinesis data stream will treat None as a value
        #which we dont want
        df_filter = df.fillna('')
